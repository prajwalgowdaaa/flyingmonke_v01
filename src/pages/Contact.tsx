...
const Contact = () => {
  return (
    <div className="min-h-screen">
      ...
      {/* Social Media */}
      <section className="section-padding bg-black/90 text-white">
        <div className="container-custom text-center">
          ...
          <div className="flex justify-center space-x-8">
            <a href="https://www.instagram.com/flyingmonke__/" target="_blank" rel="noopener noreferrer" className="p-3 bg-white/10 rounded-full hover:bg-white/20 transition-colors">
              <Instagram size={24} />
              <span className="sr-only">Instagram</span>
            </a>
						<a href="https://www.facebook.com/people/flyingmonk%C3%A9/61576847467953/" target="_blank" rel="noopener noreferrer" className="p-3 bg-white/10 rounded-full hover:bg-white/20 transition-colors">
              <Facebook size={24} />
              <span className="sr-only">Facebook</span>
            </a>            
            <a href="https://x.com/flyingmonke_" target="_blank" rel="noopener noreferrer" className="p-3 bg-white/10 rounded-full hover:bg-white/20 transition-colors">
              <X size={26} />
              <span className="sr-only">Twitter</span>
            </a>
            <a href="https://www.linkedin.com/company/flyingmonkecreativelabs" target="_blank" rel="noopener noreferrer" className="p-3 bg-white/10 rounded-full hover:bg-white/20 transition-colors">
              <Linkedin size={24} />
